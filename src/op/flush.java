...
public class flush {
    ...
    public flush(DBBean dbBean) throws SQLException {
        this.db = dbBean;
        name_sell_haveStateChaneg.add("stateChange");
    }

    private DBBean db = null;
    private final Vector<Object> name_sell_noStateChange = returnVector.getHeadName(db, "ordermanager");
    private final Vector<Object> name_sell_haveStateChaneg = returnVector.getHeadName(db, "ordermanager");
    private final Vector<Object> name_checkStock = new Vector<>(Arrays.asList("id", "name", "num", "inprice"));
