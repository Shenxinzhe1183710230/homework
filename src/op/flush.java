...
import Bean.DBBean;
import GUI.DefaultTableModel_noEditable;
...
public class flush {
    ...
    public void flushAllTables(JScrollPane scrollPane_sell_unchecked, JScrollPane jScrollPane_sell_unpaid,
        ...
        DefaultTableModel tablemodel_sell_unchecked = new DefaultTableModel_noEditable(data_sell_unchecked, name_sell_haveStateChaneg, 5);
        ...
        boolean_button.boolean_button(table_sell_unchecked, data_sell_unchecked, name_sell_haveStateChaneg.size() - 1, tablemodel_sell_unchecked, db, tcm_sell_unchecked, "2", "1",1);
        ...
        DefaultTableModel tablemodel_sell_unpaid = new DefaultTableModel_noEditable(data_sell_unpaid, name_sell_haveStateChaneg, 5);
        ...
        boolean_button.boolean_button(table_sell_unpaid, data_sell_unpaid, name_sell_haveStateChaneg.size() - 1, tablemodel_sell_unpaid, db, tcm_sell_unpaid, "3", "2",0);
        ...
        DefaultTableModel tablemodel_sell_return = new DefaultTableModel_noEditable(data_sell_return, name_sell_haveStateChaneg, 5);
        ...
        boolean_button.boolean_button(table_sell_return, data_sell_return, name_sell_haveStateChaneg.size() - 1, tablemodel_sell_return, db, tcm_sell_return, "5", "4",0);
        ...
        DefaultTableModel tablemodel_sell_returned = new DefaultTableModel_noEditable(data_sell_returned, name_sell_noStateChange, 5);
        ...
        DefaultTableModel tablemodel_sell_finish = new DefaultTableModel_noEditable(data_sell_finish, name_sell_haveStateChaneg, 5);
        ...
        boolean_button.boolean_button(table_sell_finish, data_sell_finish, name_sell_haveStateChaneg.size() - 1, tablemodel_sell_finish, db, tcm_sell_finish, "4", "3",0);
        ...
        DefaultTableModel tablemodel_sell_allOrder = new DefaultTableModel_noEditable(data_sell_allOrder, name_sell_noStateChange, 5);
        ...
        DefaultTableModel tablemodel_stock_checkStock = new DefaultTableModel_noEditable(data_stock_checkStock, name_checkStock, 5);
